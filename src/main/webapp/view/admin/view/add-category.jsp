                                ...
                                <div class="" style="padding: 28px;">
                                    <form role="form" action="${pageContext.request.contextPath}/admin/category/add" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cate_name" class="form-control" placeholder="Enter category name" />
                                        </div>
                                        <button type="submit" class="btn btn-primary">Create</button>
                                        <button type="reset" class="btn btn-warning" onclick="console.log(document.getElementById('cate_name').value);">Reset</button>
                                    </form>
                                </div>
                            </div>
                        </div>
