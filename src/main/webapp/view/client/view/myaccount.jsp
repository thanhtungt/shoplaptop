				...
				<div class="tab-content">
					<div class="tab-pane active" id="home">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="first_name"><h4>Address</h4></label> <input
									type="text" class="form-control" name="username"
									id="first_name" value="${sessionScope.account.address }"
									title="enter your first name if any.">
							</div>
							
							<div class="col-xs-6">
								<label for="first_name"><h4>Phone</h4></label> <input
									type="text" class="form-control" name="username"
									id="first_name" value="${sessionScope.account.phone }"
									title="enter your first name if any.">
							</div>
						...
						<div class="form-group">
							...
							<!-- Insert the Edit Button Here -->
<div class="form-group">
    <div class="col-xs-12">
        <br>
        <button class="btn btn-primary" type="button" onclick="location.href='${pageContext.request.contextPath}/member/editUser?id=${sessionScope.account.id}'">Edit</button>
    </div>
</div>
						</div>
						</form>
